...
const Api_key = "42e123cf9bfc6efe742193d8d8fd073c";

const App = () => {
  const inputRef = useRef(null);
  const [apiData, setApiData] = useState(null);    //datos de la API
  const [showWeather, setShowWeather] = useState(null);  //información sobre el tiempo a mostrar
  const [loading, setLoading] = useState(false);   //estado de carga

  const WeatherTypes = [                   // array de objetos que describen tipos de clima y sus iconos
    {
      type: "Clear",
  ...
  return (
    <div className="h-screen grid place-items-center">
      <div className="bg-white w-96 p-4 rounded-md">
        ...
        >
          {loading ? (              //si loading es verdadero, se muestra un indicador de carga en forma de imagen animada.
